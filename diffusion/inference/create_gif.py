...
def generate_gif(directory:str, output_file:str, duration_ms:int = 100):
    ...
    first_image.save(output_file, save_all=True, append_images=frames, duration=duration_ms, loop=0)
