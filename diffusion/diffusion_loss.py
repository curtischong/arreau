...
from diffusion.inference.visualize_crystal import vis_crystal, vis_crystal_during_diffusion
    ...
    def sample(
        ...
        for timestep in tqdm(reversed(range(1, self.T))):
            ...
            if not only_visualize_last and (timestep != self.T-1) and (timestep % 10 == 0):
                vis_crystal_during_diffusion(z_table, h, lattice, x, vis_name + f"_{timestep}")
        ...
        vis_crystal_during_diffusion(z_table, h, lattice, x, vis_name + "_final")
