...
class DiffusionLoss(torch.nn.Module):
    ...
    def __call__(self, model, batch, t_emb_weights, t_int=None):
        ...
        pred_lattice_noise = noisy_lattice - pred_l_0
    ...
    def sample(
        ...
        *,
        ...
        for timestep in tqdm(reversed(range(1, self.T))):
            ...
            _rot, pred_symmetric_matrix = polar_decomposition(pred_lattice)
            predicted_symmetric_vector_noise = symmetric_matrix_to_vector(
