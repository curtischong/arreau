...
if __name__ == "__main__":
    ...
    # QM9 Dataset
    parser.add_argument(
        "--root", type=str, default="datasets/qm9", help="Data set location"
    )
    parser.add_argument("--target", type=str, default="alpha", help="MD17 target")
    ...
    parser.add_argument(
        "--num_ori", type=int, default=-1, help="num elements of spherical grid"
    )
    parser.add_argument(
    ...
    idx = torch.tensor(
        [0, 1, 2, 3, 4, 5, 6, 12, 13, 14, 15, 11, 12, 13, 14, 15]
    )  # We will automatically replace U0 -> U0_atom etc.
